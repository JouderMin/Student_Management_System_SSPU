...
vector<StudentData> sort_by_num() {
    ...
    file->allLog(data);
    delete file;
    sort(data.begin(), data.begin() + (signed)data.size(), sort_by_num_core);
    return data;
}
...
vector<StudentData> sort_by_class() {
    ...
    file->allLog(data);
    delete file;
    sort(data.begin(), data.begin() + (signed)data.size(), sort_by_class_core);
    return data;
}
...
vector<StudentData> sort_by_course_result_1() {
    ...
    file->allLog(data);
    delete file;
    sort(data.begin(), data.begin() + (signed)data.size(), sort_by_course_result_1_core);
    return data;
}
...
vector<StudentData> sort_by_course_result_2() {
    ...
    file->allLog(data);
    delete file;
    sort(data.begin(), data.begin() + (signed)data.size(), sort_by_course_result_2_core);
    return data;
}
...
vector<StudentData> sort_by_course_result_3() {
    ...
    file->allLog(data);
    delete file;
    sort(data.begin(), data.begin() + (signed)data.size(), sort_by_course_result_3_core);
    return data;
}